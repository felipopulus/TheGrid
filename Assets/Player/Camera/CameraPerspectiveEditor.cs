...
public class CameraPerspectiveEditor : MonoBehaviour
{
	...
	[Range (3, 50)]
	public float dollyZoomFocalDistance = 3;
	...
	public Ray ViewportPointToRay (Vector3 position)
	{
		...
		if (thisCamera.orthographic)
		{
			pointConversionPosition.x = (pointConversionPosition.x - 0.5f) * 2f * thisCamera.orthographicSize;
			pointConversionPosition.y = (pointConversionPosition.y - 0.5f) * 2f * thisCamera.orthographicSize;
		}
		else
		{
	...
	public Vector3 WorldToViewportPoint (Vector3 position)
	{
		...
		if (thisCamera.orthographic)
		{
			pointToRayMatrix.m00 = 1 / thisCamera.aspect;
			pointToRayMatrix.m11 = 1;
		}
